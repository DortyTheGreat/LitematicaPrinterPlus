...
public class BuildUtils {
	...
	public static boolean place(BlockPos blockPos, Direction direction, SlabType slabType, BlockHalf blockHalf, Direction blockHorizontalOrientation, Axis wantedAxies, boolean airPlace, boolean swingHand, boolean rotate, boolean clientSide, int range, int priority) {
	...
	private static void place(BlockHitResult blockHitResult, boolean swing) {
		...
		if (true) { // TODO: find a way to find whether player should swing.
